...
# Contributing to Geodesy

Firstly, thank you for taking an interesting in contributing! Geodesy is an
...
Geodesy is one of a large number of
...
issue](https://github.com/propensive/geodesy/issues) or contact the project
...
have commit rights to the `propensive/geodesy` repository, push to a branch named
...
in extreme cases. Geodesy does not use automatic code-formatting because it
...
Geodesy&rsquo;s users. Individualism is valued, and nobody should feel
