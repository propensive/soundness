...
Firstly, thank you for taking an interesting in contributing! Distillate is an
...
Distillate is one of a large number of
...
issue](https://github.com/propensive/distillate/issues) or contact the project
...
have commit rights to the `propensive/distillate` repository, push to a branch named
...
in extreme cases. Distillate does not use automatic code-formatting because it
...
Distillate&rsquo;s users. Individualism is valued, and nobody should feel
