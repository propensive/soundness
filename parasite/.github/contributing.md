...
# Contributing to Parasite

Firstly, thank you for taking an interesting in contributing! Parasite is an
...
Parasite is one of a large number of
...
issue](https://github.com/propensive/parasite/issues) or contact the project
...
have commit rights to the `propensive/parasite` repository, push to a branch named
...
in extreme cases. Parasite does not use automatic code-formatting because it
...
Parasite&rsquo;s users. Individualism is valued, and nobody should feel
