...
# Contributing to Inimitable

Firstly, thank you for taking an interesting in contributing! Inimitable is an
...
Inimitable is one of a large number of
...
issue](https://github.com/propensive/inimitable/issues) or contact the project
...
have commit rights to the `propensive/inimitable` repository, push to a branch named
...
in extreme cases. Inimitable does not use automatic code-formatting because it
...
Inimitable&rsquo;s users. Individualism is valued, and nobody should feel
