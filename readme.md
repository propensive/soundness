...
a directory type (such as `java.io.File` or `jovian.Directory`) representing the directory. Imperial is designed to be
compatible with different file and directory representations, but it works automatically with
[Jovian](https://github.com/propensive/jovian).
