...
Chiaroscuro has not yet been published as a binary, though work is ongoing to fix this.
...
The following _Scala One_ libraries are dependencies of _Chiaroscuro_:
