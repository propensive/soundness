[<img alt="GitHub Workflow" src="https://img.shields.io/github/actions/workflow/status/propensive/revolution/main.yml?style=for-the-badge" height="24">](https://github.com/propensive/revolution/actions)
...
Revolution has not yet been published. The medium-term plan is to build Revolution
with [Fury](https://github.com/propensive/fury) and to publish it as a source build on
[Vent](https://github.com/propensive/vent). This will enable ordinary users to write and build
software which depends on Revolution.

Subsequently, Revolution will also be made available as a binary in the Maven
...
Revolution is classified as ____. For reference, Scala One projects are
