...
[<img src="https://vent.dev/badge/propensive/eucalyptus" height="24">](https://vent.dev/)
...
Eucalyptus is designed to be _small_. Its entire source code currently consists of 147 lines of code.

## Availability

Eucalyptus&rsquo;s source is available on GitHub, and may be built with [Fury](https://github.com/propensive/fury) by
cloning the layer `propensive/eucalyptus`.
```
fury layer clone -i propensive/eucalyptus
```
or imported into an existing layer with,
```
fury layer import -i propensive/eucalyptus
```
