...
[<img src="https://img.shields.io/maven-central/v/com.propensive/rudiments-core?color=2465cd&style=for-the-badge" height="24">](https://search.maven.org/artifact/com.propensive/rudiments-core)
...
Rudiments can be built on Linux or Mac OS with Vex, by running the `vex` script in the root directory:
```sh
./vex
```
