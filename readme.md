...
[<img src="https://img.shields.io/maven-central/v/com.propensive/xylophone-core?color=2465cd&style=for-the-badge" height="24">](https://search.maven.org/artifact/com.propensive/xylophone-core)
...
This works for `String`s and primitive types. But will also work for case classes composed of these types (or
...
Xylophone is designed to be _small_. Its entire source code currently consists of 646 lines of code.
