...
The following _Niveau_ libraries are dependents of _Cataract_:
...
Cataract can be built on Linux or Mac OS with Vex, by running the `vex` script in the root directory:
```sh
./vex
```
