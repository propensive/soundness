...
[<img src="https://img.shields.io/maven-central/v/com.propensive/cosmopolite-core_2.12?color=2465cd&style=for-the-badge" height="24">](https://search.maven.org/artifact/com.propensive/cosmopolite-core_2.12)
...
```
A binary is available on Maven Central as `com.propensive:cosmopolite-core_<scala-version>:0.1.0`. This may be added
to an [sbt](https://www.scala-sbt.org/) build with:
```
libraryDependencies += "com.propensive" %% "cosmopolite-core" % "0.1.0"
```
