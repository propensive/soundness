...
`SimpleSchema` and `Schema` do not currently make their precise record types available, however
these are statically known, and could potentially be made available as type members.
