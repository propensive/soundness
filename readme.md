[<img alt="GitHub Workflow" src="https://img.shields.io/github/workflow/status/propensive/polyvinyl/Build/main?style=for-the-badge" height="24">](https://github.com/propensive/polyvinyl/actions)
[<img src="https://img.shields.io/maven-central/v/com.propensive/polyvinyl-core?color=2465cd&style=for-the-badge" height="24">](https://search.maven.org/artifact/com.propensive/polyvinyl-core)
...
Polyvinyl is designed to be _small_. Its entire source code currently consists of 34 lines of code.

## Building

Polyvinyl can be built on Linux or Mac OS with Vex, by running the `vex` script in the root directory:
```sh
./vex
```
