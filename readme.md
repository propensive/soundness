...
Umbrageous has not yet been published as a binary, though work is ongoing to fix this.
...
_Umbrageous_ has no dependencies.

No other _Scala One_ libraries are dependents of _Umbrageous_.
