...
Firstly, thank you for taking an interesting in contributing! Guillotine is an
...
Guillotine is one of a large number of
...
issue](https://github.com/propensive/guillotine/issues) or contact the project
...
have commit rights to the `propensive/guillotine` repository, push to a branch named
...
in extreme cases. Guillotine does not use automatic code-formatting because it
...
Guillotine&rsquo;s users. Individualism is valued, and nobody should feel
