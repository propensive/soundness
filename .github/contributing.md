...
# Contributing to Symbolism

Firstly, thank you for taking an interesting in contributing! Symbolism is an
...
Symbolism is one of a large number of
...
issue](https://github.com/propensive/symbolism/issues) or contact the project
...
have commit rights to the `propensive/symbolism` repository, push to a branch named
...
in extreme cases. Symbolism does not use automatic code-formatting because it
...
Symbolism&rsquo;s users. Individualism is valued, and nobody should feel
