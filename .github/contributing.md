...
# Contributing to Phoenicia

Firstly, thank you for taking an interesting in contributing! Phoenicia is an
...
Phoenicia is one of a large number of
...
issue](https://github.com/propensive/phoenicia/issues) or contact the project
...
have commit rights to the `propensive/phoenicia` repository, push to a branch named
...
in extreme cases. Phoenicia does not use automatic code-formatting because it
...
Phoenicia&rsquo;s users. Individualism is valued, and nobody should feel
