...
# Contributing to Superlunary

Firstly, thank you for taking an interesting in contributing! Superlunary is an
...
Superlunary is one of a large number of
...
issue](https://github.com/propensive/superlunary/issues) or contact the project
...
have commit rights to the `propensive/superlunary` repository, push to a branch named
...
in extreme cases. Superlunary does not use automatic code-formatting because it
...
Superlunary&rsquo;s users. Individualism is valued, and nobody should feel
