...
Firstly, thank you for taking an interesting in contributing! Tarantula is an
...
Tarantula is one of a large number of
...
issue](https://github.com/propensive/tarantula/issues) or contact the project
...
have commit rights to the `propensive/tarantula` repository, push to a branch named
...
in extreme cases. Tarantula does not use automatic code-formatting because it
...
Tarantula&rsquo;s users. Individualism is valued, and nobody should feel
