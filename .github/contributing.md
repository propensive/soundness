...
# Contributing to Hieroglyph

Firstly, thank you for taking an interesting in contributing! Hieroglyph is an
...
Hieroglyph is one of a large number of
...
issue](https://github.com/propensive/hieroglyph/issues) or contact the project
...
have commit rights to the `propensive/hieroglyph` repository, push to a branch named
...
in extreme cases. Hieroglyph does not use automatic code-formatting because it
...
Hieroglyph&rsquo;s users. Individualism is valued, and nobody should feel
