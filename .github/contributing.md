...
Firstly, thank you for taking an interesting in contributing! Profanity is an
...
Profanity is one of a large number of
...
issue](https://github.com/propensive/profanity/issues) or contact the project
...
have commit rights to the `propensive/profanity` repository, push to a branch named
...
in extreme cases. Profanity does not use automatic code-formatting because it
...
Profanity&rsquo;s users. Individualism is valued, and nobody should feel
