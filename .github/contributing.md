...
Firstly, thank you for taking an interesting in contributing! Scintillate is an
...
Scintillate is one of a large number of
...
issue](https://github.com/propensive/scintillate/issues) or contact the project
...
have commit rights to the `propensive/scintillate` repository, push to a branch named
...
in extreme cases. Scintillate does not use automatic code-formatting because it
...
Scintillate&rsquo;s users. Individualism is valued, and nobody should feel
