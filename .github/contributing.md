...
# Contributing to Bitumen

Firstly, thank you for taking an interesting in contributing! Bitumen is an
...
Bitumen is one of a large number of
...
issue](https://github.com/propensive/bitumen/issues) or contact the project
...
have commit rights to the `propensive/bitumen` repository, push to a branch named
...
in extreme cases. Bitumen does not use automatic code-formatting because it
...
Bitumen&rsquo;s users. Individualism is valued, and nobody should feel
