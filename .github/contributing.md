...
Firstly, thank you for taking an interesting in contributing! Quantitative is an
...
Quantitative is one of a large number of
...
issue](https://github.com/propensive/quantitative/issues) or contact the project
...
have commit rights to the `propensive/quantitative` repository, push to a branch named
...
in extreme cases. Quantitative does not use automatic code-formatting because it
...
Quantitative&rsquo;s users. Individualism is valued, and nobody should feel
