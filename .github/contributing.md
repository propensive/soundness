...
Firstly, thank you for taking an interesting in contributing! Wisteria is an
...
Wisteria is one of a large number of
...
issue](https://github.com/propensive/wisteria/issues) or contact the project
...
have commit rights to the `propensive/wisteria` repository, push to a branch named
...
in extreme cases. Wisteria does not use automatic code-formatting because it
...
Wisteria&rsquo;s users. Individualism is valued, and nobody should feel
