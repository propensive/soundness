...
# Contributing to Hypotenuse

Firstly, thank you for taking an interesting in contributing! Hypotenuse is an
...
Hypotenuse is one of a large number of
...
issue](https://github.com/propensive/hypotenuse/issues) or contact the project
...
have commit rights to the `propensive/hypotenuse` repository, push to a branch named
...
in extreme cases. Hypotenuse does not use automatic code-formatting because it
...
Hypotenuse&rsquo;s users. Individualism is valued, and nobody should feel
