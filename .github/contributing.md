...
# Contributing to Hyperbole

Firstly, thank you for taking an interesting in contributing! Hyperbole is an
...
Hyperbole is one of a large number of
...
issue](https://github.com/propensive/hyperbole/issues) or contact the project
...
have commit rights to the `propensive/hyperbole` repository, push to a branch named
...
in extreme cases. Hyperbole does not use automatic code-formatting because it
...
Hyperbole&rsquo;s users. Individualism is valued, and nobody should feel
