...
Firstly, thank you for taking an interesting in contributing! Ethereal is an
...
Ethereal is one of a large number of
...
issue](https://github.com/propensive/ethereal/issues) or contact the project
...
have commit rights to the `propensive/ethereal` repository, push to a branch named
...
in extreme cases. Ethereal does not use automatic code-formatting because it
...
Ethereal&rsquo;s users. Individualism is valued, and nobody should feel
