...
Firstly, thank you for taking an interesting in contributing! Aviation is an
...
Aviation is one of a large number of
...
issue](https://github.com/propensive/aviation/issues) or contact the project
...
have commit rights to the `propensive/aviation` repository, push to a branch named
...
in extreme cases. Aviation does not use automatic code-formatting because it
...
Aviation&rsquo;s users. Individualism is valued, and nobody should feel
