...
Firstly, thank you for taking an interesting in contributing! Telekinesis is an
...
Telekinesis is one of a large number of
...
issue](https://github.com/propensive/telekinesis/issues) or contact the project
...
have commit rights to the `propensive/telekinesis` repository, push to a branch named
...
in extreme cases. Telekinesis does not use automatic code-formatting because it
...
Telekinesis&rsquo;s users. Individualism is valued, and nobody should feel
