...
Firstly, thank you for taking an interesting in contributing! Turbulence is an
...
Turbulence is one of a large number of
...
issue](https://github.com/propensive/turbulence/issues) or contact the project
...
have commit rights to the `propensive/turbulence` repository, push to a branch named
...
in extreme cases. Turbulence does not use automatic code-formatting because it
...
Turbulence&rsquo;s users. Individualism is valued, and nobody should feel
