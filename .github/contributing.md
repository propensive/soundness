...
Firstly, thank you for taking an interesting in contributing! Anticipation is an
...
Anticipation is one of a large number of
...
issue](https://github.com/propensive/anticipation/issues) or contact the project
...
have commit rights to the `propensive/anticipation` repository, push to a branch named
...
in extreme cases. Anticipation does not use automatic code-formatting because it
...
Anticipation&rsquo;s users. Individualism is valued, and nobody should feel
