...
# Contributing to Octogenarian

Firstly, thank you for taking an interesting in contributing! Octogenarian is an
...
Octogenarian is one of a large number of
...
issue](https://github.com/propensive/octogenarian/issues) or contact the project
...
have commit rights to the `propensive/octogenarian` repository, push to a branch named
...
in extreme cases. Octogenarian does not use automatic code-formatting because it
...
Octogenarian&rsquo;s users. Individualism is valued, and nobody should feel
