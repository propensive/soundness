...
# Contributing to Bifurcate

Firstly, thank you for taking an interesting in contributing! Bifurcate is an
...
Bifurcate is one of a large number of
...
issue](https://github.com/propensive/bifurcate/issues) or contact the project
...
have commit rights to the `propensive/bifurcate` repository, push to a branch named
...
in extreme cases. Bifurcate does not use automatic code-formatting because it
...
Bifurcate&rsquo;s users. Individualism is valued, and nobody should feel
