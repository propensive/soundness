...
# Contributing to Savagery

Firstly, thank you for taking an interesting in contributing! Savagery is an
...
Savagery is one of a large number of
...
issue](https://github.com/propensive/savagery/issues) or contact the project
...
have commit rights to the `propensive/savagery` repository, push to a branch named
...
in extreme cases. Savagery does not use automatic code-formatting because it
...
Savagery&rsquo;s users. Individualism is valued, and nobody should feel
