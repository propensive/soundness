...
Firstly, thank you for taking an interesting in contributing! Acyclicity is an
...
Acyclicity is one of a large number of
...
issue](https://github.com/propensive/acyclicity/issues) or contact the project
...
have commit rights to the `propensive/acyclicity` repository, push to a branch named
...
in extreme cases. Acyclicity does not use automatic code-formatting because it
...
Acyclicity&rsquo;s users. Individualism is valued, and nobody should feel
