...
Firstly, thank you for taking an interesting in contributing! Chiaroscuro is an
...
Chiaroscuro is one of a large number of
...
issue](https://github.com/propensive/chiaroscuro/issues) or contact the project
...
have commit rights to the `propensive/chiaroscuro` repository, push to a branch named
...
in extreme cases. Chiaroscuro does not use automatic code-formatting because it
...
Chiaroscuro&rsquo;s users. Individualism is valued, and nobody should feel
