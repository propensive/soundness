...
Firstly, thank you for taking an interesting in contributing! Punctuation is an
...
Punctuation is one of a large number of
...
issue](https://github.com/propensive/punctuation/issues) or contact the project
...
have commit rights to the `propensive/punctuation` repository, push to a branch named
...
in extreme cases. Punctuation does not use automatic code-formatting because it
...
Punctuation&rsquo;s users. Individualism is valued, and nobody should feel
