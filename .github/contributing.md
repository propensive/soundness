...
Firstly, thank you for taking an interesting in contributing! Escritoire is an
...
Escritoire is one of a large number of
...
issue](https://github.com/propensive/escritoire/issues) or contact the project
...
have commit rights to the `propensive/escritoire` repository, push to a branch named
...
in extreme cases. Escritoire does not use automatic code-formatting because it
...
Escritoire&rsquo;s users. Individualism is valued, and nobody should feel
