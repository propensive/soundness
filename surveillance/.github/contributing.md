...
Firstly, thank you for taking an interesting in contributing! Surveillance is an
...
Surveillance is one of a large number of
...
issue](https://github.com/propensive/surveillance/issues) or contact the project
...
have commit rights to the `propensive/surveillance` repository, push to a branch named
...
in extreme cases. Surveillance does not use automatic code-formatting because it
...
Surveillance&rsquo;s users. Individualism is valued, and nobody should feel
