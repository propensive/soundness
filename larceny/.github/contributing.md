...
# Contributing to Larceny

Firstly, thank you for taking an interesting in contributing! Larceny is an
...
Larceny is one of a large number of
...
issue](https://github.com/propensive/larceny/issues) or contact the project
...
have commit rights to the `propensive/larceny` repository, push to a branch named
...
in extreme cases. Larceny does not use automatic code-formatting because it
...
Larceny&rsquo;s users. Individualism is valued, and nobody should feel
