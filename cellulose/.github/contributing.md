...
# Contributing to Cellulose

Firstly, thank you for taking an interesting in contributing! Cellulose is an
...
Cellulose is one of a large number of
...
issue](https://github.com/propensive/cellulose/issues) or contact the project
...
have commit rights to the `propensive/cellulose` repository, push to a branch named
...
in extreme cases. Cellulose does not use automatic code-formatting because it
...
Cellulose&rsquo;s users. Individualism is valued, and nobody should feel
