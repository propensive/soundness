...
Firstly, thank you for taking an interesting in contributing! Cosmopolite is an
...
Cosmopolite is one of a large number of
...
issue](https://github.com/propensive/cosmopolite/issues) or contact the project
...
have commit rights to the `propensive/cosmopolite` repository, push to a branch named
...
in extreme cases. Cosmopolite does not use automatic code-formatting because it
...
Cosmopolite&rsquo;s users. Individualism is valued, and nobody should feel
