...
(`SN-546.1`, `UnknownDocument`, was retired when `YamlPath` lost its never-populated document URL
and `YamlPath.Registry`; the remaining numbers are unchanged.)
...
- Source: `lib/ypsiloid/src/core/ypsiloid.YamlPath.scala`
