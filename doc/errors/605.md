...
| `SN-605.121` | `BadSchemaIdentifier` | the schema identifier is neither a valid URL nor a BASE-256 schema signature |
| `SN-605.122` | `ExtraPragmaContent` | the pragma line has extra atoms or a remark |
