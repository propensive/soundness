...
Roughly 24–30 PRs. After mod-1, these tracks are independent and can proceed in parallel:
the escapade chain (urticose.ansi → escapade decomposition → spectacular inversions);
...
facsimile → dedup chain; and the staged kernel.
