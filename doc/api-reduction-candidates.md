...
- **Names whose outer concept is in another library.** The largest remaining group, and the
  ...
  concept as the outer name they appear to share. Moving any of these means moving a *type*
...
Blocked because the *outer* name belongs to another library, which the family tables cannot
