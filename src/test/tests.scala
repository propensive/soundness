...
object Tests extends Suite(t"CoDL tests"):
  ...
  def run(using Runner): Unit = supervise(t"main"):
    ...
    //                     | uneven indented
    //                     |""".s.stripMargin.show)
    //   .assert(_ == CodlParseError(1, 1, CodlParseError.Issue.UnevenIndent(0, 1)))
    ...
    //                     |   uneven indented
    //                     |""".s.stripMargin.show)
    //   .assert(_ == CodlParseError(1, 3, CodlParseError.Issue.UnevenIndent(0, 3)))
    ...
    //                     |    uneven indented
    //                     |""".s.stripMargin.show)
    //   .assert(_ == CodlParseError(1, 4, CodlParseError.Issue.InsufficientIndent))
      
    //   test(t"Indent after comment forbidden"):
    //     capture(parseText(t"root\n  # comment\n    child"))
    //   .assert(_ == CodlParseError(2, 4, CodlParseError.Issue.IndentAfterComment))
    ...
    //                     | deindentation
    //                     |""".s.stripMargin.show)
    //   .assert(_ == CodlParseError(2, 1, CodlParseError.Issue.UnevenIndent(0, 1)))
    ...
    //   .assert(_ == CodlValidationError(0, 0, t"first", CodlValidationError.Issue.DuplicateId(1, 2)))
