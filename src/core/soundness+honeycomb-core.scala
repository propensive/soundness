...
export honeycomb.{cls, id, A, Abbr, Address, Area, Article, Aside, Audio, B, Base, Bdi, Bdo,
    ...
    H1, H2, H3, H4, H5, H6, HMap, Head, Header, Hgroup, Hr, I, Iframe, Img, Input, Ins, Kbd, Label,
    Legend, Li, Link, Main, Mark, Menu, Meta, Meter, Nav, Noscript, HObject, Ol, Optgroup, Option,
