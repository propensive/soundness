...
extension (bs: Int)
  ...
  def kb: Memory = Memory(bs*1024L)
  def mb: Memory = Memory(bs*1024L*1024)
  def gb: Memory = Memory(bs*1024L*1024*1024)
  def tb: Memory = Memory(bs*1024L*1024*1024*1024)

extension (bs: Long)
  def b: Memory = Memory(bs)
  def kb: Memory = Memory(bs*1024)
  def mb: Memory = Memory(bs*1024*1024)
  def gb: Memory = Memory(bs*1024*1024*1024)
  def tb: Memory = Memory(bs*1024*1024*1024*1024)
