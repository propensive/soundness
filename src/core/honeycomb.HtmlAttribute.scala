...
object HtmlAttribute:
  ...
  given ("checked" is HtmlAttribute[Boolean]) as checkedBoolean = if _ then Unset else NotShown
  ...
  given ("controls" is HtmlAttribute[Boolean]) as controls = if _ then Unset else NotShown
  ...
  given ("default" is HtmlAttribute[Boolean]) as default = if _ then Unset else NotShown
  given ("defer" is HtmlAttribute[Boolean]) as defer = if _ then Unset else NotShown
  ...
  given ("disabled" is HtmlAttribute[Boolean]) as disabled = if _ then Unset else NotShown

  // should be a filename, but probably best as `Text`
  given ("download" is HtmlAttribute[Text]) as download = identity(_)

  given ("draggable" is HtmlAttribute[Boolean]) as draggable = if _ then Unset else NotShown
  ...
  given ("formnovalidate" is HtmlAttribute[Boolean]) as formnovalidate = if _ then Unset else NotShown
  ...
  given ("hidden" is HtmlAttribute[Boolean]) as hidden = if _ then Unset else NotShown
  ...
  given ("ismap" is HtmlAttribute[Boolean]) as ismap = if _ then Unset else NotShown
  ...
  given ("loop" is HtmlAttribute[Boolean]) as loop = if _ then Unset else NotShown
  ...
  given ("multiple" is HtmlAttribute[Boolean]) as multiple = if _ then Unset else NotShown
  given ("muted" is HtmlAttribute[Boolean]) as muted = if _ then Unset else NotShown
  ...
  given ("novalidate" is HtmlAttribute[Boolean]) as novalidate = if _ then Unset else NotShown
  given ("open" is HtmlAttribute[Boolean]) as open = if _ then Unset else NotShown
  ...
  given ("playsinline" is HtmlAttribute[Boolean]) as playsinline = if _ then Unset else NotShown
  given ("poster" is HtmlAttribute[Text]) as poster = identity(_)
  given ("preload" is HtmlAttribute[Preload]) as preload = _.show
  given ("readonly" is HtmlAttribute[Boolean]) as readonly = if _ then Unset else NotShown
  ...
  given ("required" is HtmlAttribute[Boolean]) as required = if _ then Unset else NotShown
  ...
  given ("selected" is HtmlAttribute[Boolean]) as selected = if _ then Unset else NotShown
  ...
  given ("spellcheck" is HtmlAttribute[Boolean]) as spellcheck = if _ then Unset else NotShown
  ...
  given ("translate" is HtmlAttribute[Boolean]) as translate = if _ then Unset else NotShown
