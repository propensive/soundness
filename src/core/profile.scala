/*
    Iridescence, version [unreleased]. Copyright 2023 Jon Pretty, Propensive OÜ.
...
object colorProfiles:
  given incandescentTungsten: ColorProfile = ColorProfile(109.850, 100, 35.585, 111.144, 100, 35.200)
