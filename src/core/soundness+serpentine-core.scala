...
export serpentine.{Directional, Followable, Hierarchy, Navigable, PathCreator, PathEquality, Name,
    PathError, PExtractor, Radical, RootParser, Serpentine, SimpleLink, SimplePath, `%`, `?`,
    `?^`, `?^^`, `?^^^`, ascent, inWorkingDirectory, root, relativeTo, retain, conjunction,
