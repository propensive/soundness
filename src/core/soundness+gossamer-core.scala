...
export gossamer.{Bidi, Buffer, Cuttable, Decimalizer, Interpolation, Joinable, Numerous,
    ...
    upper, plain, drop, take, capitalize, uncapitalize, head, last, tail, init, empty, chars,
    slice, snip, char, reverse, contains, has, at, trim, where, upto, dropWhile, snipWhere,
    whilst, mapChars, count, metrics, pad, center, fit, uncamel, unkebab, unsnake, starts, ends,
