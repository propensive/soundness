...
trait PosixCommands:
  ...
  erased given cat: ("cat" is Intelligible into LazyList[Text]) = ###
  ...
  erased given grep: ("grep" is Intelligible into LazyList[Text]) = ###
  erased given hash: ("hash" is Intelligible into Text) = ###
  erased given head: ("head" is Intelligible into LazyList[Text]) = ###
  ...
  erased given ls: ("ls" is Intelligible into LazyList[Text]) = ###
  erased given m4: ("m4" is Intelligible into Text) = ###
  erased given mailx: ("mailx" is Intelligible into Text) = ###
  erased given man: ("man" is Intelligible into LazyList[Text]) = ###
  ...
  erased given sed: ("sed" is Intelligible into LazyList[Text]) = ###
  erased given sleep: ("sleep" is Intelligible into Exit) = ###
  erased given sort: ("sort" is Intelligible into LazyList[Text]) = ###
  erased given split: ("split" is Intelligible into Text) = ###
  erased given strings: ("strings" is Intelligible into LazyList[Text]) = ###
  erased given stty: ("stty" is Intelligible into Text) = ###
  erased given tabs: ("tabs" is Intelligible into Text) = ###
  erased given tail: ("tail" is Intelligible into LazyList[Text]) = ###
  ...
  erased given uniq: ("uniq" is Intelligible into LazyList[Text]) = ###
