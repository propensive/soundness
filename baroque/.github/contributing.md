...
# Contributing to Baroque

Firstly, thank you for taking an interesting in contributing! Baroque is an
...
Baroque is one of a large number of
...
issue](https://github.com/propensive/baroque/issues) or contact the project
...
have commit rights to the `propensive/baroque` repository, push to a branch named
...
in extreme cases. Baroque does not use automatic code-formatting because it
...
Baroque&rsquo;s users. Individualism is valued, and nobody should feel
