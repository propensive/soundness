...
Firstly, thank you for taking an interesting in contributing! Guillotine is an open-source project, and welcomes
...
Guillotine is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Guillotine is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.guillotine:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.guillotine:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/guillotine` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Guillotine does not use automatic code-formatting
...
development environment for all Guillotine&rsquo;s users. Propensive O&Uuml; reserves the right to censure
