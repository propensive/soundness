...
# Contributing to Tarantula

Firstly, thank you for taking an interesting in contributing! Tarantula is an open-source project, and welcomes
...
Tarantula is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Tarantula is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.tarantula:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.tarantula:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/tarantula` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Tarantula does not use automatic code-formatting
...
development environment for all Tarantula&rsquo;s users. Propensive O&Uuml; reserves the right to censure
