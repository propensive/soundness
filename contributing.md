...
# Contributing to Nettlesome

Firstly, thank you for taking an interesting in contributing! Nettlesome is an
...
Nettlesome is one of a large number of
...
issue](https://github.com/propensive/nettlesome/issues) or contact the project
...
have commit rights to the `propensive/nettlesome` repository, push to a branch named
...
in extreme cases. Nettlesome does not use automatic code-formatting because it
...
Nettlesome&rsquo;s users. Individualism is valued, and nobody should feel
