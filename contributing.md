...
# Contributing to Cosmopolite

Firstly, thank you for taking an interesting in contributing! Cosmopolite is an open-source project, and welcomes
...
Cosmopolite is developed using [Fury](https://github.com/propensive/fury), which may be installed by running the
...
The simplest way to compile Cosmopolite is to run,
```
fury
```
...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.cosmopolite:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.cosmopolite:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/cosmopolite` repository, please only push to
...
rejected on grounds of formatting, except in extreme cases. Cosmopolite does not use automatic code-formatting
...
development environment for all Cosmopolite&rsquo;s users. Propensive O&Uuml; reserves the right to censure
