...
Firstly, thank you for taking an interesting in contributing! Dissonance is an
...
Dissonance is one of a large number of
...
issue](https://github.com/propensive/dissonance/issues) or contact the project
...
have commit rights to the `propensive/dissonance` repository, push to a branch named
...
in extreme cases. Dissonance does not use automatic code-formatting because it
...
Dissonance&rsquo;s users. Individualism is valued, and nobody should feel
