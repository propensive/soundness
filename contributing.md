...
It&rsquo;s a good idea to [discuss](https://riot.im/app/#/room/#propensive.acyclicity:matrix.org) potential changes
...
If a response is not forthcoming in the [Riot chatroom](https://riot.im/app/#/room/#propensive.acyclicity:matrix.org),
...
issue before work starts. If you have commit rights to the `propensive/acyclicity` repository, please only push to
