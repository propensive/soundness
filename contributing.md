...
# Contributing to Fulminate

Firstly, thank you for taking an interesting in contributing! Fulminate is an
...
Fulminate is one of a large number of
...
issue](https://github.com/propensive/fulminate/issues) or contact the project
...
have commit rights to the `propensive/fulminate` repository, push to a branch named
...
in extreme cases. Fulminate does not use automatic code-formatting because it
...
Fulminate&rsquo;s users. Individualism is valued, and nobody should feel
