...
# Contributing to Umbrageous

Firstly, thank you for taking an interesting in contributing! Umbrageous is an
...
Umbrageous is one of a large number of
...
issue](https://github.com/propensive/umbrageous/issues) or contact the project
...
have commit rights to the `propensive/umbrageous` repository, push to a branch named
...
in extreme cases. Umbrageous does not use automatic code-formatting because it
...
Umbrageous&rsquo;s users. Individualism is valued, and nobody should feel
