...
Firstly, thank you for taking an interesting in contributing! Honeycomb is an
...
Honeycomb is one of a large number of
...
issue](https://github.com/propensive/honeycomb/issues) or contact the project
...
have commit rights to the `propensive/honeycomb` repository, push to a branch named
...
in extreme cases. Honeycomb does not use automatic code-formatting because it
...
Honeycomb&rsquo;s users. Individualism is valued, and nobody should feel
