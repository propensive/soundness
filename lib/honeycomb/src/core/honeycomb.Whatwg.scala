...
class Whatwg() extends Dom:
  ...
  val Colgroup = Tag.container["colgroup", "col"]
                  (content = Html.TextContent.Whitespace, insertable = true).in[Whatwg]
  ...
  val Dl = Tag.container["dl", "div" | "dt" | ScriptSupporting]
            (autoclose = true, content = Html.TextContent.Whitespace).in[Whatwg]
  ...
  val Menu = Tag.container["menu", "li" | ScriptSupporting](content = Html.TextContent.Whitespace).in[Whatwg]
  ...
  val Ol = Tag.container["ol", "li" | ScriptSupporting](content = Html.TextContent.Whitespace).in[Whatwg]
  ...
  val Picture = Tag.container["picture", "source" | "img" | ScriptSupporting]
                 (content = Html.TextContent.Whitespace).in[Whatwg]
  ...
  val Script = Tag.container["script", "#text"](content = Html.TextContent.Raw).in[Whatwg]
  ...
  val Style = Tag.container["style", "#text"](content = Html.TextContent.Raw).in[Whatwg]
  ...
  val Textarea = Tag.container["textarea", "#text"](content = Html.TextContent.Rcdata).in[Whatwg]
  ...
  val Title = Tag.container["title", "#text"](content = Html.TextContent.Rcdata).in[Whatwg]
