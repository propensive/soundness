...
class Whatwg() extends Dom:
  ...
  object Area extends Tag.Void("area", murmuration.Map(), false):
    type Topic = "area"
    type Transport = ""
    type Form = Whatwg

    val Default = Tag.void["input", Whatwg](presets = murmuration.Map(t"shape" -> t"default"))
    val Rect = Tag.void["input", Whatwg](presets = murmuration.Map(t"shape" -> t"rect"))
    val Circle = Tag.void["input", Whatwg](presets = murmuration.Map(t"shape" -> t"circle"))
    val Poly = Tag.void["input", Whatwg](presets = murmuration.Map(t"shape" -> t"poly"))
  ...
  object Input extends Tag.Void("input", murmuration.Map(), false):
    ...
    val Hidden = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"hidden"))
    val Text = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"text"))
    val Search = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"search"))
    val Tel = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"tel"))
    val Url = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"url"))
    val Email = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"email"))
    val Password = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"password"))
    val Date = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"date"))
    val Month = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"month"))
    val Week = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"week"))
    val Time = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"time"))

    val DatetimeLocal =
      Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"datetime-local"))

    val Number = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"number"))
    val Range = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"range"))
    val Color = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"color"))
    val Checkbox = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"checkbox"))
    val Radio = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"radio"))
    val Submit = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"submit"))
    val Image = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"image"))
    val Reset = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"reset"))
    val Button = Tag.void["input", Whatwg](presets = murmuration.Map(t"type" -> t"button"))
  ...
  object Link extends Tag.Void("link", murmuration.Map(), false):
    type Topic = "link"
    type Transport = ""
    type Form = Whatwg

    val Alternate = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"alternate"))
    val Canonical = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"canonical"))
    val Author = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"author"))
    val DnsPrefetch = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"dns-prefetch"))
    val Expect = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"expect"))
    val Help = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"help"))
    val Icon = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"icon"))
    val Manifest = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"manifest"))
    val Modulepreload = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"modulepreload"))
    val License = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"license"))
    val Next = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"next"))
    val Pingback = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"pingback"))
    val Preconnect = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"preconnect"))
    val Prefetch = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"prefetch"))
    val Preload = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"preload"))
    val Prev = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"prev"))
    val PrivacyPolicy = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"privacy-policy"))
    val Search = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"search"))
    val Stylesheet = Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"stylesheet"))

    val TermsOfService =
      Tag.void["link", Whatwg](presets = murmuration.Map(t"rel" -> t"terms-of-service"))
  ...
  object Meta extends Tag.Void("meta", murmuration.Map(), false):
    val ApplicationName =
      Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"application-name"))

    val Author = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"author"))
    val Description = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"description"))
    val Generator = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"generator"))
    val Keywords = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"keywords"))
    val Referrer = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"referrer"))
    val Viewport = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"viewport"))
    val ThemeColor = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"theme-color"))
    val ColorScheme = Tag.void["meta", Whatwg](presets = murmuration.Map(t"name" -> t"color-scheme"))
  ...
  object Track extends Tag.Void("track", murmuration.Map(), false):
    type Topic = "track"
    type Transport = ""
    type Form = Whatwg

    val Captions = Tag.void["track", Whatwg](presets = murmuration.Map(t"kind" -> t"captions"))
    val Chapters = Tag.void["track", Whatwg](presets = murmuration.Map(t"kind" -> t"chapters"))
    val Descriptions = Tag.void["track", Whatwg](presets = murmuration.Map(t"kind" -> t"descriptions"))
    val Metadata = Tag.void["track", Whatwg](presets = murmuration.Map(t"kind" -> t"metadata"))
    val Subtitles = Tag.void["track", Whatwg](presets = murmuration.Map(t"kind" -> t"subtitles"))
