...
# Contributing to Embarcadero

Firstly, thank you for taking an interesting in contributing! Embarcadero is an
...
Embarcadero is one of a large number of
...
issue](https://github.com/propensive/embarcadero/issues) or contact the project
...
have commit rights to the `propensive/embarcadero` repository, push to a branch named
...
in extreme cases. Embarcadero does not use automatic code-formatting because it
...
Embarcadero&rsquo;s users. Individualism is valued, and nobody should feel
