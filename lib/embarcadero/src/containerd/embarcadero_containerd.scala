...
val Launch: Mode granting Workload.Grant.Launch = new Mode { type Grants = Workload.Grant.Launch }
val Signal: Mode granting Workload.Grant.Signal = new Mode { type Grants = Workload.Grant.Signal }
