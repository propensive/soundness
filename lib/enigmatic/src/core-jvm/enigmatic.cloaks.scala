...
private def reload(segment: jlf.MemorySegment, length: Int): scala.Array[Byte] =
...
private def freshKey(): scala.Array[Byte] =
...
private def aes[result](keyBytes: scala.Array[Byte], mode: Int, nonce: scala.Array[Byte])
