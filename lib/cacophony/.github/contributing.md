...
Firstly, thank you for taking an interesting in contributing! Cacophony is an
...
Cacophony is one of a large number of
...
issue](https://github.com/propensive/cacophony/issues) or contact the project
...
have commit rights to the `propensive/cacophony` repository, push to a branch named
...
in extreme cases. Cacophony does not use automatic code-formatting because it
...
Cacophony&rsquo;s users. Individualism is valued, and nobody should feel
