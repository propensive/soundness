...
Firstly, thank you for taking an interesting in contributing! Anthology is an
...
Anthology is one of a large number of
...
issue](https://github.com/propensive/anthology/issues) or contact the project
...
have commit rights to the `propensive/anthology` repository, push to a branch named
...
in extreme cases. Anthology does not use automatic code-formatting because it
...
Anthology&rsquo;s users. Individualism is valued, and nobody should feel
