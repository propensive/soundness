...
object IslamicMonth extends MonthRadix:
  given showable: IslamicMonth is Showable =
    ...
    case RabiAlThani   => "Rabi II"
    case JumadaAlAwwal => "Jumada I"
    case JumadaAlThani => "Jumada II"
    case Rajab         => "Rajab"
    case Shaban        => "Shaban"
    case Ramadan       => "Ramadan"
    case Shawwal       => "Shawwal"
    case DhuAlQadah    => "Dhu al-Qadah"
    case DhuAlHijjah   => "Dhu al-Hijjah"
