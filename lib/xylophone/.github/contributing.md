...
Firstly, thank you for taking an interesting in contributing! Xylophone is an
...
Xylophone is one of a large number of
...
issue](https://github.com/propensive/xylophone/issues) or contact the project
...
have commit rights to the `propensive/xylophone` repository, push to a branch named
...
in extreme cases. Xylophone does not use automatic code-formatting because it
...
Xylophone&rsquo;s users. Individualism is valued, and nobody should feel
