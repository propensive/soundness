...
object internal extends protointernal:
  ...
  object Quantity extends Quantity2:
    ...
    transparent inline given squareRoot: [value <: Measure] =>  Quantity[value] is Rootable[2] =
      ${quantitative.internal.sqrtTypeclass[value]}

    transparent inline given cubeRoot: [value <: Measure] =>  Quantity[value] is Rootable[3] =
      ${quantitative.internal.cbrtTypeclass[value]}
    ...
    given commensurable: [units <: Measure, units2 <: Measure] => Quantity[units] is Commensurable:
      ...
      :   Boolean =
        ...
        ${quantitative.internal.greaterThan[units, units2]('left, 'right, 'strict, 'greaterThan)}
