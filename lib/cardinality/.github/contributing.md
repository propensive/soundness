...
Firstly, thank you for taking an interesting in contributing! Cardinality is an
...
Cardinality is one of a large number of
...
issue](https://github.com/propensive/cardinality/issues) or contact the project
...
have commit rights to the `propensive/cardinality` repository, push to a branch named
...
in extreme cases. Cardinality does not use automatic code-formatting because it
...
Cardinality&rsquo;s users. Individualism is valued, and nobody should feel
