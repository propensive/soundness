...
Firstly, thank you for taking an interesting in contributing! Spectacular is an
...
Spectacular is one of a large number of
...
issue](https://github.com/propensive/spectacular/issues) or contact the project
...
have commit rights to the `propensive/spectacular` repository, push to a branch named
...
in extreme cases. Spectacular does not use automatic code-formatting because it
...
Spectacular&rsquo;s users. Individualism is valued, and nobody should feel
