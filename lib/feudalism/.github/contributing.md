...
# Contributing to Feudalism

Firstly, thank you for taking an interesting in contributing! Feudalism is an
...
Feudalism is one of a large number of
...
issue](https://github.com/propensive/feudalism/issues) or contact the project
...
have commit rights to the `propensive/feudalism` repository, push to a branch named
...
in extreme cases. Feudalism does not use automatic code-formatting because it
...
Feudalism&rsquo;s users. Individualism is valued, and nobody should feel
