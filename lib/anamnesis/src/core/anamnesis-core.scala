...
infix type -< [LeftType, RightType] = Relation[LeftType, RightType]
infix type >- [LeftType, RightType] = Relation[RightType, LeftType]

class Database[RelationType <: Relation[?, ?]]():
