...
Firstly, thank you for taking an interesting in contributing! Escapade is an
...
Escapade is one of a large number of
...
issue](https://github.com/propensive/escapade/issues) or contact the project
...
have commit rights to the `propensive/escapade` repository, push to a branch named
...
in extreme cases. Escapade does not use automatic code-formatting because it
...
Escapade&rsquo;s users. Individualism is valued, and nobody should feel
