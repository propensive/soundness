...
Firstly, thank you for taking an interesting in contributing! Exoskeleton is an
...
Exoskeleton is one of a large number of
...
issue](https://github.com/propensive/exoskeleton/issues) or contact the project
...
have commit rights to the `propensive/exoskeleton` repository, push to a branch named
...
in extreme cases. Exoskeleton does not use automatic code-formatting because it
...
Exoskeleton&rsquo;s users. Individualism is valued, and nobody should feel
