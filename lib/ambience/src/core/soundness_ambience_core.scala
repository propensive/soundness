...
export
  ambience
  . { Architecture, Directories, Environment, EnvironmentError, Property, PropertyError,
      Protovariable, System, TemporaryDirectory, temporaryDirectory, Variable, variables,
