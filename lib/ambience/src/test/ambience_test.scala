  ...
  def run(): Unit =
    ...
    suite(m"Variable override tests"):
      ...
      test(m"An overridden name is snake-cased"):
        ...
        variables(xdgDataHome = "/data"):
          unsafely(Environment[Text]("XDG_DATA_HOME"))
      . assert(_ == "/data")

      test(m"Several variables can be overridden at once"):
        given environment: Environment = fixedEnvironment()

        variables(home = "/home/jill", term = "xterm"):
          (unsafely(Environment[Text]("HOME")), unsafely(Environment[Text]("TERM")))
      . assert(_ == ("/home/jill", "xterm"))
    ...
    suite(m"System property tests"):
      ...
      test(m"The empty system defines no properties"):
        systems.emptySystem("user.home")
      . assert(_ == Unset)

      test(m"The Java system reads a real property"):
        systems.javaBaseSystem("java.version") == Unset
      . assert(_ == false)
    ...
    suite(m"Configurator tests"):
      ...
      test(m"The environment configurator maps a name to SCREAMING_SNAKE_CASE"):
        ...
        Configurator.environment.read("logLevel")
      . assert(_ == "info")
      ...
      test(m"The properties configurator maps a name to dotted lower case"):
        ...
        Configurator.properties.read("logLevel")
      . assert(_ == "warn")
      ...
      test(m"Composition prefers the left configurator"):
        ...
        (Configurator.properties ++ Configurator.environment).read("port")
      . assert(_ == "8080")
      ...
      test(m"A composed cascade falls through to a custom source"):
        given environment: Environment = fixedEnvironment()
        given system: System = fixedSystem()
        val file: Configurator = name => if name == "port" then "7070" else Unset
        (Configurator.properties ++ Configurator.environment ++ file).read("port")
      . assert(_ == "7070")
    ...
    suite(m"Directory tests"):
      ...
      . assert(_ == FakePath("C:\\Users\\Jack\\AppData\\Roaming"))
      ...
      . assert(_ == FakePath("C:\\Users\\Jack\\AppData\\Local"))
