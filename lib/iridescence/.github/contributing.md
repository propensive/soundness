...
Firstly, thank you for taking an interesting in contributing! Iridescence is an
...
Iridescence is one of a large number of
...
issue](https://github.com/propensive/iridescence/issues) or contact the project
...
have commit rights to the `propensive/iridescence` repository, push to a branch named
...
in extreme cases. Iridescence does not use automatic code-formatting because it
...
Iridescence&rsquo;s users. Individualism is valued, and nobody should feel
