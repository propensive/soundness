...
Firstly, thank you for taking an interesting in contributing! Mosquito is an
...
Mosquito is one of a large number of
...
issue](https://github.com/propensive/mosquito/issues) or contact the project
...
have commit rights to the `propensive/mosquito` repository, push to a branch named
...
in extreme cases. Mosquito does not use automatic code-formatting because it
...
Mosquito&rsquo;s users. Individualism is valued, and nobody should feel
