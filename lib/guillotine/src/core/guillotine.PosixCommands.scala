...
trait PosixCommands:
  ...
  inline given cat: ("cat" is Intelligible to LazyList[Text]) = !!
  ...
  inline given grep: ("grep" is Intelligible to LazyList[Text]) = !!
  inline given hash: ("hash" is Intelligible to Text) = !!
  inline given head: ("head" is Intelligible to LazyList[Text]) = !!
  ...
  inline given ls: ("ls" is Intelligible to LazyList[Text]) = !!
  inline given m4: ("m4" is Intelligible to Text) = !!
  inline given mailx: ("mailx" is Intelligible to Text) = !!
  inline given man: ("man" is Intelligible to LazyList[Text]) = !!
  ...
  inline given sed: ("sed" is Intelligible to LazyList[Text]) = !!
  inline given sleep: ("sleep" is Intelligible to Exit) = !!
  inline given sort: ("sort" is Intelligible to LazyList[Text]) = !!
  inline given split: ("split" is Intelligible to Text) = !!
  inline given strings: ("strings" is Intelligible to LazyList[Text]) = !!
  inline given stty: ("stty" is Intelligible to Text) = !!
  inline given tabs: ("tabs" is Intelligible to Text) = !!
  inline given tail: ("tail" is Intelligible to LazyList[Text]) = !!
  ...
  inline given uniq: ("uniq" is Intelligible to LazyList[Text]) = !!
