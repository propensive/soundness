...
# Contributing to Abacist

Firstly, thank you for taking an interesting in contributing! Abacist is an
...
Abacist is one of a large number of
...
issue](https://github.com/propensive/abacist/issues) or contact the project
...
have commit rights to the `propensive/abacist` repository, push to a branch named
...
in extreme cases. Abacist does not use automatic code-formatting because it
...
Abacist&rsquo;s users. Individualism is valued, and nobody should feel
