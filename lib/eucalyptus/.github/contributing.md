...
Firstly, thank you for taking an interesting in contributing! Eucalyptus is an
...
Eucalyptus is one of a large number of
...
issue](https://github.com/propensive/eucalyptus/issues) or contact the project
...
have commit rights to the `propensive/eucalyptus` repository, push to a branch named
...
in extreme cases. Eucalyptus does not use automatic code-formatting because it
...
Eucalyptus&rsquo;s users. Individualism is valued, and nobody should feel
