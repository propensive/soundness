...
# Contributing to Monotonous

Firstly, thank you for taking an interesting in contributing! Monotonous is an
...
Monotonous is one of a large number of
...
issue](https://github.com/propensive/monotonous/issues) or contact the project
...
have commit rights to the `propensive/monotonous` repository, push to a branch named
...
in extreme cases. Monotonous does not use automatic code-formatting because it
...
Monotonous&rsquo;s users. Individualism is valued, and nobody should feel
