...
package alphabets:
  given binaryStandard: Alphabet[Binary] = Alphabet("01", false)

  given quaternaryStandard: Alphabet[Quaternary] = Alphabet("0123", false)
  given quaternaryDnaNucleotide: Alphabet[Quaternary] = Alphabet("ATCG", false)

  given octalStandard: Alphabet[Octal] = Alphabet("01234567=", false)

  given hexStrictUpperCase: Alphabet[Hex] = Alphabet("0123456789ABCDEF", false)
  given hexStrictLowerCase: Alphabet[Hex] = Alphabet("0123456789abcdef", false)

  given hexUpperCase: Alphabet[Hex] =
    Alphabet("0123456789ABCDEF", false, hexStrictLowerCase.inverse)

  given hexLowerCase: Alphabet[Hex] =
    Alphabet("0123456789abcdef", false, hexStrictUpperCase.inverse)

  given hexBioctal: Alphabet[Hex] = Alphabet("01234567cjzwfsbv", false)

  given base32StrictUpperCase: Alphabet[Base32] =
    Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", true)

  given base32StrictLowerCase: Alphabet[Base32] =
    Alphabet("abcdefghijklmnopqrstuvwxyz234567=", true)

  given base32UpperCase: Alphabet[Base32] =
    Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", true, base32StrictLowerCase.inverse)

  given base32LowerCase: Alphabet[Base32] =
    Alphabet("abcdefghijklmnopqrstuvwxyz234567=", true, base32StrictUpperCase.inverse)

  given base32ExtendedHexUpperCase: Alphabet[Base32] =
    Alphabet("0123456789ABCDEFGHIJKLMNOPQRSTUV=", true, base32StrictLowerCase.inverse)

  given base32ExtendedHexLowerCase: Alphabet[Base32] =
    Alphabet("0123456789abcdefghijklmnopqrstuv=", true, base32StrictUpperCase.inverse)

  given base32ZBase32: Alphabet[Base32] = Alphabet("ybndrfg8ejkmcpqxot1uwisza345h769=", true)

  given base32ZBase32Unpadded: Alphabet[Base32] =
    Alphabet("ybndrfg8ejkmcpqxot1uwisza345h769", false)

  given base32Geohash: Alphabet[Base32] = Alphabet("0123456789bcdefghjkmnpqrstuvwxyz", false)
  given base32WordSafe: Alphabet[Base32] = Alphabet("23456789CFGHJMPQRVWXcfghjmpqrvwx", false)

  private val crockfordAlternatives =
    Alphabet("0123456789abcdefghjkmnpqrstvwxyz", false).inverse +
      Map('o' -> 0, 'O' -> 0, 'i' -> 1, 'I' -> 1, 'L' -> 1)

  given base32Crockford: Alphabet[Base32] =
    Alphabet("0123456789ABCDEFGHJKMNPQRSTVWXYZ", false, crockfordAlternatives)

  given base64Standard: Alphabet[Base64] =
    Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", true)

  given base64Unpadded: Alphabet[Base64] =
    Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", false)

  given base64Url: Alphabet[Base64] =
    Alphabet("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", false)
