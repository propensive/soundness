...
# Contributing to Coaxial

Firstly, thank you for taking an interesting in contributing! Coaxial is an
...
Coaxial is one of a large number of
...
issue](https://github.com/propensive/coaxial/issues) or contact the project
...
have commit rights to the `propensive/coaxial` repository, push to a branch named
...
in extreme cases. Coaxial does not use automatic code-formatting because it
...
Coaxial&rsquo;s users. Individualism is valued, and nobody should feel
