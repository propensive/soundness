...
# Contributing to Urticose

Firstly, thank you for taking an interesting in contributing! Urticose is an
...
Urticose is one of a large number of
...
issue](https://github.com/propensive/urticose/issues) or contact the project
...
have commit rights to the `propensive/urticose` repository, push to a branch named
...
in extreme cases. Urticose does not use automatic code-formatting because it
...
Urticose&rsquo;s users. Individualism is valued, and nobody should feel
