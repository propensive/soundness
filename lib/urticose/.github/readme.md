[<img alt="GitHub Workflow" src="https://img.shields.io/github/actions/workflow/status/propensive/urticose/main.yml?style=for-the-badge" height="24">](https://github.com/propensive/urticose/actions)
...
generality is typically nontrivial, and it is for this reason that __Urticose__
exists.
...
Urticose is capable of representing all of the following:
...
Urticose is classified as __maturescent__. For reference, Soundness projects are
...
Urticose is designed to be _small_. Its entire source code currently consists
of 1160 lines of code.

## Building

Urticose will ultimately be built by Fury, when it is published. In the
meantime, two possibilities are offered, however they are acknowledged to be
fragile, inadequately tested, and unsuitable for anything more than
experimentation. They are provided only for the necessity of providing _some_
answer to the question, "how can I try Urticose?".

1. *Copy the sources into your own project*

   Read the `fury` file in the repository root to understand Urticose's build
...
2. *Build with [Wrath](https://github.com/propensive/wrath/)*
   ...
   Wrath is a bootstrapping script for building Urticose and other projects in
   ...
   safely make clones of repositories it depends on as _peers_ of `urticose`.
   Run `wrath -F` in the repository root. This will download and compile the
   latest version of Scala, as well as all of Urticose's dependencies.
...
Contributors to Urticose are welcome and encouraged. New contributors may like
to look for issues marked
[beginner](https://github.com/propensive/urticose/labels/beginner).

We suggest that all contributors read the [Contributing
Guide](/contributing.md) to make the process of contributing to Urticose
easier.
...
Urticose was designed and developed by Jon Pretty, and commercial support and
...
_Urticose_ means the abundance or resemblance of _nettles_, the stinging weeds
that share their first three letters with _network_, which is the subject of the
facilities provided by Urticose.
...
Urticose is copyright &copy; 2025 Jon Pretty & Propensive O&Uuml;, and
