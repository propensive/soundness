...
export gossamer.{Bidi, Builder, Cuttable, Decimalizer, Interpolation, Joinable, Numerous,
    Presentational, Pue, RangeError, TextBuilder, Textual, append, construct, fill, txt, t, utf8,
    ...
    unsnake, starts, ends, tr, subscripts, superscripts, sub, urlEncode, urlDecode, punycode,
