...
Firstly, thank you for taking an interesting in contributing! Gossamer is an
...
Gossamer is one of a large number of
...
issue](https://github.com/propensive/gossamer/issues) or contact the project
...
have commit rights to the `propensive/gossamer` repository, push to a branch named
...
in extreme cases. Gossamer does not use automatic code-formatting because it
...
Gossamer&rsquo;s users. Individualism is valued, and nobody should feel
