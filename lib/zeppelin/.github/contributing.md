...
Firstly, thank you for taking an interesting in contributing! Zeppelin is an
...
Zeppelin is one of a large number of
...
issue](https://github.com/propensive/zeppelin/issues) or contact the project
...
have commit rights to the `propensive/zeppelin` repository, push to a branch named
...
in extreme cases. Zeppelin does not use automatic code-formatting because it
...
Zeppelin&rsquo;s users. Individualism is valued, and nobody should feel
