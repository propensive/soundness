...
# Contributing to Plutocrat

Firstly, thank you for taking an interesting in contributing! Plutocrat is an
...
Plutocrat is one of a large number of
...
issue](https://github.com/propensive/plutocrat/issues) or contact the project
...
have commit rights to the `propensive/plutocrat` repository, push to a branch named
...
in extreme cases. Plutocrat does not use automatic code-formatting because it
...
Plutocrat&rsquo;s users. Individualism is valued, and nobody should feel
