...
# Contributing to Hellenism

Firstly, thank you for taking an interesting in contributing! Hellenism is an
...
Hellenism is one of a large number of
...
issue](https://github.com/propensive/hellenism/issues) or contact the project
...
have commit rights to the `propensive/hellenism` repository, push to a branch named
...
in extreme cases. Hellenism does not use automatic code-formatting because it
...
Hellenism&rsquo;s users. Individualism is valued, and nobody should feel
