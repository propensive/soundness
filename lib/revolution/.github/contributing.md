...
Firstly, thank you for taking an interesting in contributing! Revolution is an
...
Revolution is one of a large number of
...
issue](https://github.com/propensive/revolution/issues) or contact the project
...
have commit rights to the `propensive/revolution` repository, push to a branch named
...
in extreme cases. Revolution does not use automatic code-formatting because it
...
Revolution&rsquo;s users. Individualism is valued, and nobody should feel
