...
# Contributing to Vicarious

Firstly, thank you for taking an interesting in contributing! Vicarious is an
...
Vicarious is one of a large number of
...
issue](https://github.com/propensive/vicarious/issues) or contact the project
...
have commit rights to the `propensive/vicarious` repository, push to a branch named
...
in extreme cases. Vicarious does not use automatic code-formatting because it
...
Vicarious&rsquo;s users. Individualism is valued, and nobody should feel
