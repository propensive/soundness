...
# Contributing to Villainy

Firstly, thank you for taking an interesting in contributing! Villainy is an
...
Villainy is one of a large number of
...
issue](https://github.com/propensive/villainy/issues) or contact the project
...
have commit rights to the `propensive/villainy` repository, push to a branch named
...
in extreme cases. Villainy does not use automatic code-formatting because it
...
Villainy&rsquo;s users. Individualism is valued, and nobody should feel
