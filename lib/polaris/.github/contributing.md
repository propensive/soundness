...
Firstly, thank you for taking an interesting in contributing! Polaris is an
...
Polaris is one of a large number of
...
issue](https://github.com/propensive/polaris/issues) or contact the project
...
have commit rights to the `propensive/polaris` repository, push to a branch named
...
in extreme cases. Polaris does not use automatic code-formatting because it
...
Polaris&rsquo;s users. Individualism is valued, and nobody should feel
