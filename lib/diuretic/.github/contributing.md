...
# Contributing to Diuretic

Firstly, thank you for taking an interesting in contributing! Diuretic is an
...
Diuretic is one of a large number of
...
issue](https://github.com/propensive/diuretic/issues) or contact the project
...
have commit rights to the `propensive/diuretic` repository, push to a branch named
...
in extreme cases. Diuretic does not use automatic code-formatting because it
...
Diuretic&rsquo;s users. Individualism is valued, and nobody should feel
