...
Firstly, thank you for taking an interesting in contributing! Harlequin is an
...
Harlequin is one of a large number of
...
issue](https://github.com/propensive/harlequin/issues) or contact the project
...
have commit rights to the `propensive/harlequin` repository, push to a branch named
...
in extreme cases. Harlequin does not use automatic code-formatting because it
...
Harlequin&rsquo;s users. Individualism is valued, and nobody should feel
