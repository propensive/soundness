...
# Contributing to Jacinta

Firstly, thank you for taking an interesting in contributing! Jacinta is an
...
Jacinta is one of a large number of
...
issue](https://github.com/propensive/jacinta/issues) or contact the project
...
have commit rights to the `propensive/jacinta` repository, push to a branch named
...
in extreme cases. Jacinta does not use automatic code-formatting because it
...
Jacinta&rsquo;s users. Individualism is valued, and nobody should feel
