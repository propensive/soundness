...
case class Maction(contents: List[Mathml], attributes: List[(Text, Text)] = Nil) extends Semantic:
...
case class Semantics(contents: List[Mathml], attributes: List[(Text, Text)] = Nil) extends Semantic:
