...
# Contributing to Vacuous

Firstly, thank you for taking an interesting in contributing! Vacuous is an
...
Vacuous is one of a large number of
...
issue](https://github.com/propensive/vacuous/issues) or contact the project
...
have commit rights to the `propensive/vacuous` repository, push to a branch named
...
in extreme cases. Vacuous does not use automatic code-formatting because it
...
Vacuous&rsquo;s users. Individualism is valued, and nobody should feel
