...
# Contributing to Ulysses

Firstly, thank you for taking an interesting in contributing! Ulysses is an
...
Ulysses is one of a large number of
...
issue](https://github.com/propensive/ulysses/issues) or contact the project
...
have commit rights to the `propensive/ulysses` repository, push to a branch named
...
in extreme cases. Ulysses does not use automatic code-formatting because it
...
Ulysses&rsquo;s users. Individualism is valued, and nobody should feel
