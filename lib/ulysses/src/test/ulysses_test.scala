...
object Tests extends Suite(m"Ulysses tests"):
  def run(): Unit =
    ...
    val numbers = List(t"one", t"two", t"three", t"four", t"five", t"six", t"seven", t"eight", t"9", t"10", t"11", t"12", t"13", t"14", t"15", t"16").map { n => Array.frozen(n.digest[Blake3].data.stdlib.slice(0, 12)) }
