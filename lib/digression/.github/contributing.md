...
# Contributing to Digression

Firstly, thank you for taking an interesting in contributing! Digression is an
...
Digression is one of a large number of
...
issue](https://github.com/propensive/digression/issues) or contact the project
...
have commit rights to the `propensive/digression` repository, push to a branch named
...
in extreme cases. Digression does not use automatic code-formatting because it
...
Digression&rsquo;s users. Individualism is valued, and nobody should feel
