...
# Contributing to Capricious

Firstly, thank you for taking an interesting in contributing! Capricious is an
...
Capricious is one of a large number of
...
issue](https://github.com/propensive/capricious/issues) or contact the project
...
have commit rights to the `propensive/capricious` repository, push to a branch named
...
in extreme cases. Capricious does not use automatic code-formatting because it
...
Capricious&rsquo;s users. Individualism is valued, and nobody should feel
