...
# Contributing to Dendrology

Firstly, thank you for taking an interesting in contributing! Dendrology is an
...
Dendrology is one of a large number of
...
issue](https://github.com/propensive/dendrology/issues) or contact the project
...
have commit rights to the `propensive/dendrology` repository, push to a branch named
...
in extreme cases. Dendrology does not use automatic code-formatting because it
...
Dendrology&rsquo;s users. Individualism is valued, and nobody should feel
