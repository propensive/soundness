...
# Contributing to Hallucination

Firstly, thank you for taking an interesting in contributing! Hallucination is an
...
Hallucination is one of a large number of
...
issue](https://github.com/propensive/hallucination/issues) or contact the project
...
have commit rights to the `propensive/hallucination` repository, push to a branch named
...
in extreme cases. Hallucination does not use automatic code-formatting because it
...
Hallucination&rsquo;s users. Individualism is valued, and nobody should feel
