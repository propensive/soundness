...
# Contributing to Metamorphose

Firstly, thank you for taking an interesting in contributing! Metamorphose is an
...
Metamorphose is one of a large number of
...
issue](https://github.com/propensive/metamorphose/issues) or contact the project
...
have commit rights to the `propensive/metamorphose` repository, push to a branch named
...
in extreme cases. Metamorphose does not use automatic code-formatting because it
...
Metamorphose&rsquo;s users. Individualism is valued, and nobody should feel
