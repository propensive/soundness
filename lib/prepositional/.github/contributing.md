...
# Contributing to Prepositional

Firstly, thank you for taking an interesting in contributing! Prepositional is an
...
Prepositional is one of a large number of
...
issue](https://github.com/propensive/prepositional/issues) or contact the project
...
have commit rights to the `propensive/prepositional` repository, push to a branch named
...
in extreme cases. Prepositional does not use automatic code-formatting because it
...
Prepositional&rsquo;s users. Individualism is valued, and nobody should feel
