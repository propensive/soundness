...
Firstly, thank you for taking an interesting in contributing! Serpentine is an
...
Serpentine is one of a large number of
...
issue](https://github.com/propensive/serpentine/issues) or contact the project
...
have commit rights to the `propensive/serpentine` repository, push to a branch named
...
in extreme cases. Serpentine does not use automatic code-formatting because it
...
Serpentine&rsquo;s users. Individualism is valued, and nobody should feel
