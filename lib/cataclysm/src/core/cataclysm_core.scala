...
package formatting:
  given standardCssFormatting: CssFormatting = CssFormatting(newlines = true, spaces = true)
  given compactCssFormatting: CssFormatting = CssFormatting(newlines = false, spaces = false)
