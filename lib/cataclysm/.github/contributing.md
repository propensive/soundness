...
Firstly, thank you for taking an interesting in contributing! Cataclysm is an
...
Cataclysm is one of a large number of
...
issue](https://github.com/propensive/cataclysm/issues) or contact the project
...
have commit rights to the `propensive/cataclysm` repository, push to a branch named
...
in extreme cases. Cataclysm does not use automatic code-formatting because it
...
Cataclysm&rsquo;s users. Individualism is valued, and nobody should feel
