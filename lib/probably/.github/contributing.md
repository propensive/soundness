...
Firstly, thank you for taking an interesting in contributing! Probably is an
...
Probably is one of a large number of
...
issue](https://github.com/propensive/probably/issues) or contact the project
...
have commit rights to the `propensive/probably` repository, push to a branch named
...
in extreme cases. Probably does not use automatic code-formatting because it
...
Probably&rsquo;s users. Individualism is valued, and nobody should feel
