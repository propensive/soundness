...
Firstly, thank you for taking an interesting in contributing! Imperial is an
...
Imperial is one of a large number of
...
issue](https://github.com/propensive/imperial/issues) or contact the project
...
have commit rights to the `propensive/imperial` repository, push to a branch named
...
in extreme cases. Imperial does not use automatic code-formatting because it
...
Imperial&rsquo;s users. Individualism is valued, and nobody should feel
