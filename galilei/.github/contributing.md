...
# Contributing to Galilei

Firstly, thank you for taking an interesting in contributing! Galilei is an
...
Galilei is one of a large number of
...
issue](https://github.com/propensive/galilei/issues) or contact the project
...
have commit rights to the `propensive/galilei` repository, push to a branch named
...
in extreme cases. Galilei does not use automatic code-formatting because it
...
Galilei&rsquo;s users. Individualism is valued, and nobody should feel
